...
def get_highest_deviation(deviations):
    ...
    with open(f'test_data/result/graph/Python/highest_dev_{i}_dim_{j}.txt', 'w') as file:
...
def get_lowest_deviation(deviations):
    ...
    with open(f'test_data/result/graph/Python/lowest_dev_{i}_dim_{j}.txt', 'w') as file:
